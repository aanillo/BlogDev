...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <main class="flex-grow flex flex-col items-center px-6 mt-44">
        ...
        >
            ...
            <div class="bg-neutral-900 w-full sm:w-[60%] mx-auto border-2 border-emerald-500 text-emerald-500 px-4 py-4 rounded-lg shadow-md mb-12 text-center transition transform hover:scale-105">
    ...
    <time class="text-neutral-500" x-text="post.created_at"></time>
            ...
            <div class="flex justify-center items-center gap-4 mt-8" x-show="totalPages > 1">
                <button 
                    ...
                    class="px-4 py-2 bg-neutral-800 text-purple-600 border-2 border-purple-600 rounded-lg disabled:opacity-50"
