...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <section class="w-[85%] px-10 py-12 bg-lime-50 border border-neutral-200 rounded-3xl shadow-xl mb-12">

        <!-- Título del post -->
        <div class="bg-neutral-900 w-[65%] mx-auto border-2 border-lime-500 text-lime-300 px-10 py-6 rounded-xl shadow-md mb-12 text-center transition transform hover:scale-105">
            <h1 class="text-5xl font-extrabold leading-tight">{{ $post->title }}</h1>
        </div>

        <!-- Grid principal -->
        <div class="grid grid-cols-[70%_28%] gap-12">

            <!-- Columna izquierda -->
            <div class="flex flex-col gap-10">

                <!-- Metadata -->
                <div class="flex justify-between items-center text-black flex-wrap gap-4">
                    <div>
                    ...
                    <div>
                        <span class="inline-block px-5 py-2 text-xl font-semibold bg-neutral-800 text-lime-400 rounded-xl shadow-lg">
                            {{ $post->type }}
                        </span>
                    </div>
                </div>
                ...
                <!-- Contenido del post -->
                <article class="prose max-w-none bg-white text-black bg-lime-50 border-l-8 border-r-8 border-lime-500 p-8 text-lg rounded-2xl shadow-md transition hover:shadow-xl">
                    {!! $post->post !!}
                </article>
            ...
            <div class="flex flex-col rounded-2xl p-6 max-h-[650px] overflow-auto bg-white shadow-lg border border-neutral-200">
