...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <main class="flex-grow flex flex-col items-center px-6 mt-44">
        ...
        >
            ...
            <!-- TÍTULO -->
<div class="bg-neutral-900 w-full sm:w-[60%] mx-auto border-2 border-yellow-500 text-yellow-500 px-4 py-4 rounded-lg shadow-md mb-12 text-center transition transform hover:scale-105">
