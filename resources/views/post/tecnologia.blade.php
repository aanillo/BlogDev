...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <main class="flex-grow flex flex-col items-center px-6 mt-44">
        ...
        <section 
            ...
            class="w-[100%] sm:w-[90%] md:w-[90%] px-10 py-12 bg-white border border-neutral-300 rounded-2xl shadow-lg mb-12"
        >

            <div class="bg-neutral-900 w-full sm:w-[60%] mx-auto border-2 border-indigo-500 text-indigo-500 px-4 py-4 rounded-lg shadow-md mb-12 text-center transition transform hover:scale-105">
    <h1 class="text-3xl sm:text-4xl font-bold leading-tight break-words">Posts de {{ $type }}</h1>
</div>
    ...
    <input
        ...
        class="w-full pl-10 p-2 border-2 border-black rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600"
    />
</div>
    ...
    <div class="bg-neutral-800 border border-indigo-500 text-indigo-500 px-3 py-1 rounded-lg text-sm">
    ...
    <time class="text-neutral-500" x-text="post.created_at"></time>
                            ...
                            <a 
                                ...
                                class="mt-auto inline-block text-indigo-600 hover:text-indigo-800 font-semibold text-lg transition-colors cursor-pointer"
                            >
                                Ver post completo →
                            </a>
                        </div>
            ...
            <div class="flex justify-center items-center gap-4 mt-8" x-show="totalPages > 1">
                <button 
                    ...
                    class="px-4 py-2 bg-neutral-800 text-indigo-500 border-2 border-indigo-500 rounded-lg disabled:opacity-50"
