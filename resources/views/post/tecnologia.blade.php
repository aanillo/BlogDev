...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <main class="flex-grow flex flex-col items-center px-6 mt-48">
        ...
        <section 
            ...
            class="w-[80%] px-10 py-12 bg-indigo-50 border border-neutral-300 rounded-2xl shadow-lg mb-12"
        >
            <div class="bg-neutral-800 w-[60%] mx-auto border-2 border-indigo-500 text-indigo-500 px-8 py-6 rounded-lg shadow-md mb-12 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto" x-show="allPosts.length > 0">
                <template x-for="post in paginatedPosts" :key="post.id">
                    <article class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
                        <div class="bg-indigo-500 p-2 rounded-lg text-center">
                        ...
                        <div class="flex justify-between items-center text-lg text-black">
                            ...
                            <div class="bg-neutral-800 border-2 border-indigo-500 text-indigo-500 w-[30%] p-2 text-center rounded-lg h-[40px] flex items-center justify-center">
                        ...
                        <a @click="window.location.href = baseUrl + post.id" 
                           class="text-indigo-600 hover:underline font-semibold text-xl cursor-pointer">
                            Ver post completo →
                        </a>
                    </article>
                </template>
