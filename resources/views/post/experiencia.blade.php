...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <main class="flex-grow flex flex-col items-center px-6 mt-44">
        ...
        >
            ...
            <div class="bg-neutral-900 w-full sm:w-[60%] mx-auto border-2 border-orange-600 text-orange-600 px-4 py-4 rounded-lg shadow-md mb-12 text-center transition transform hover:scale-105">
    ...
    <input
        ...
        class="w-full pl-10 p-2 border-2 border-black rounded-md focus:outline-none focus:ring-2 focus:ring-orange-600"
    />
</div>
    ...
    <div class="bg-neutral-800 border border-orange-600 text-orange-600 px-3 py-1 rounded-lg text-sm">
    ...
    <time class="text-neutral-500" x-text="post.created_at"></time>
                            ...
                            <a 
                                ...
                                class="mt-auto inline-block text-orange-700 hover:text-orange-900 font-semibold text-lg transition-colors cursor-pointer"
                            >
                                Ver post completo →
                            </a>
                        </div>
