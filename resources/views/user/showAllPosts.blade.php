...
<body class="flex flex-col min-h-screen bg-neutral-100 font-[Courier New] text-black">
    ...
    <main class="flex-grow flex flex-col items-center px-6 mt-48">
        ...
        <section 
            ...
            class="w-[80%] px-10 py-12 bg-lime-100 border border-neutral-300 rounded-2xl shadow-lg mb-12"
        >
            ...
            <template x-if="allPosts.length === 0">
                <p class="text-center text-neutral-700 text-xl italic">Este usuario aún no ha publicado ningún post.</p>
            </template>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto" x-show="allPosts.length > 0">
                <template x-for="post in paginatedPosts" :key="post.id">
                    <article class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300">
                        <div class="bg-lime-500 p-2 rounded-lg text-center">
                        ...
                        <div class="flex justify-between items-center text-lg text-black">
                            <p>{{ $user->username }}</p>
                            <div class="bg-neutral-800 border-2 border-lime-500 text-lime-500 w-[30%] p-2 text-center rounded-lg h-[40px] flex items-center justify-center">
   ...
   class="text-lime-600 hover:underline font-semibold text-xl cursor-pointer">
    Ver post completo →
</a>
            ...
            <div class="flex justify-center items-center gap-4 mt-8" x-show="totalPages > 1">
                <button 
                    ...
                    class="px-4 py-2 bg-neutral-800 text-lime-500 border-2 border-lime-500 rounded-lg disabled:opacity-50"
