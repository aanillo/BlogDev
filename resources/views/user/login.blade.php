            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-4">
                ...
                <div class="flex flex-col gap-10 mt-8">
                    ...
                    <div class="flex flex-col items-center gap-6 mt-4">
                        ...
                        <div class="flex flex-row gap-10">
                            <button type="submit"
                                class="bg-lime-300 font-bold w-64 text-black text-xl border-2 border-black px-6 py-2 rounded-md hover:bg-lime-500 transition-transform duration-300 ease-in-out hover:scale-110">
                            Iniciar sesión
                        </button>

                        <button type="reset"
                                class="bg-red-500 font-bold w-64 text-black text-xl border-2 border-black px-6 py-2 rounded-md hover:bg-red-700 transform transition-transform duration-300 ease-in-out hover:scale-110">
                            Cancelar
                        </button>
                        </div>
                        ...
                        <div class="text-center mt-16">
                            ...
                            <a href="{{ route('register.show') }}"
                               class="inline-block w-72 bg-indigo-700 text-lime-200 text-xl text-center font-bold border border-lime-200 px-10 py-1.5 rounded-md hover:bg-indigo-900 transform transition-transform duration-500 ease-in-out hover:scale-110">
                                Regístrate
                            </a>
                        </div>
                    </div>
                ...
                <div class="flex flex-col justify-center items-center gap-8">
                    ...
                    <div class="flex flex-col items-center gap-2 mb-8">
                        ...
                        <a href="{{ url('/') }}"
                           class="btnHome w-64 bg-[#1f1b16] text-lime-200 text-xl text-center font-bold border border-lime-200 px-10 py-1.5 rounded-md hover:bg-black transform transition-transform duration-1000 ease-in-out hover:scale-110">
                            Home
                        </a>
                    </div>
                </div>
